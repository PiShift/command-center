<x-layouts.app title="Edit Recurring Charge">
...
<div style="max-width:680px;margin:0 auto;padding:32px 24px">
    ...
    <div style="margin-bottom:24px">
        ...
        <h1 style="font-size:22px;font-weight:700;color:#141413;margin:0">Edit Recurring Charge</h1>
    </div>
    ...
    <form method="POST" action="{{ route('recurring-charges.update', $recurringCharge) }}"
          style="background:#fff;border:1px solid #e5e4df;border-radius:12px;padding:28px">
        @csrf @method('PUT')

        @include('recurring-charges._form', ['charge' => $recurringCharge])
